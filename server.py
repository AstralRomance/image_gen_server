...
def hello(arg):
    ...
    if visualizing_data['plot_type'] == 'euclidean_scatter':
        make_process(vis.make_euclidean_scatter_plot,
                     visualizing_data['estimator_name'],
        ...
        make_process(vis.make_compare_plot,
                     visualizing_data['points_x'],
                     visualizing_data['points_y'],
                     visualizing_data['picture_name']
                    )
    elif visualizing_data['plot_type'] == 'simple_graph':
        make_process(vis.make_simple_graph,
                     visualizing_data['points_x'],
        ...
        dataframe_matrix = pd.read_json(visualizing_data['dataframe_matrix'])
        make_process(vis.make_pairplot,
                     dataframe_matrix,
                     visualizing_data['ages_columns'],
                     visualizing_data['picture_name']
                    )
    elif visualizing_data['plot_type'] == 'overfit_check':
        make_process(vis.make_overfit_check_plot,
                     visualizing_data['train_score_list'],
        ...
        make_process(vis.make_confusion_matrix,
                     visualizing_data['input_labels'],
                     visualizing_data['predicted_labels'],
                     visualizing_data['train_length']
                    )
    elif visualizing_data['plot_type'] == 'distr_hist':
        make_process(vis.distribution_hist,
                     visualizing_data['predictor_values'],
                     visualizing_data['cluster_name'],
